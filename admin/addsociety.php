...
<section class="appoinment-section section">
    ...
    <form name="contact_form" class="default-form contact-form" action="../controleur/addsociety.php" method="post">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
              ...
              <div class="form-group">
                    <input type="hidden" name="Id_ed" placeholder="First Name" value="3" required="">
                </div>
              <div class="form-group">
                    <select name="Id_ed"  id="Id_ed" >
                      <option value="">Sélectionner une edition</option>
                      <?php 
...
?>
               ...
               <div class="form-group">
                    <select name="type_org"  id="id_org" >
...
?>
                ...
                <div class="form-group">
                    <input type="text" name="nom_society" placeholder="Name" required="">
                ...
                <div class="form-group">
                     <input type="file" name="img_society" accept="image/*">
                </div>
            </div>
