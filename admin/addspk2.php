...
<section class="appoinment-section section">
    ...
    <div class="section-title">
        <h3>list of speaker from previous edition  </h3>
       
    </div>
    <form name="contact_form" class="default-form contact-form" action="../controleur/addspk2.php" method="post">
  ...
  <tbody>
    <?php  
                              ...
                              foreach ($re as $key => $value) {
                                ...
                                $res=$s->consultation_id_ed($value[0]);
    ...
    <tr>
      ...
      <th ><?php echo $r[3]; ?></th>
      <th ><?php echo $r[4]; ?></th>
     <th ><input type="checkbox" name="check_list[]" value="<?php  echo $r[0]; ?>"></th>
...
<div class="col-md-12 text-right">
                            <button class="btn btn-style-one" type="submit">choose</button>
                        </div>
