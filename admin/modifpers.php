...
<section class="appoinment-section section">
    ...
    <form name="contact_form" class="default-form contact-form" action="../controleur/modifpers.php" method="post">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="form-group"> </div>
              <div class="form-group">
                    <select name="Id_ed"  id="Id_ed" value="">
               ...
               <div class="form-group">
                    <select name="nom_com"  id="nom_com" value="" >
                ...
                <div class="form-group">
               <input type="hidden" name="id_per"  value="<?php echo $p->id_per; ?>" >
             </div>
                <div class="form-group">
                    <input type="text" name="prenom_per" value="<?php echo $p->prenom_per; ?>" required="">
                    
                </div>
                
                <div class="form-group">
                    <input type="text" name="nom_per" value="<?php echo $p->nom_per; ?>" required="">
                </div>
                
                <div class="form-group">
                     <input type="file" name="photo_per" accept="image/*" value="<?php echo $p->photo_per; ?>">
                </div>
            </div>
