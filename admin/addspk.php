...
<section class="appoinment-section section">
                ...
                <div class="contact-area">
                  <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="addspk2.php" >add from previous editions</a>
                        </li>
                      </ul>
                    </div>
    ...
    <form name="contact_form" class="default-form contact-form" action="../controleur/addspk.php" method="post">
        <div class="row">
...
?>
                ...
                <div class="form-group">
                    <input type="text" name="poste" placeholder="post" required="">
                    
                </div>

                <div class="form-group">
                    <input type="text" name="biblio" placeholder="bibliography" required="">
