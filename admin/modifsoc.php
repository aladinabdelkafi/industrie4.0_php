...
$row=$p->consult_Id_soc($_GET['id']);
 foreach($row as $r)
{
$p->id_society=$_GET['id'];
$p->nom_society= $r[1];
$p->img_society=$r[2] ;
$p->id_org=$r[3];

}
$res2=$o->consult_id_org($p->id_org);
foreach($res2 as $r)
{
$type=$r[2];
...
<section class="appoinment-section section">
    ...
    <form name="contact_form" class="default-form contact-form" action="../controleur/modifsoc.php" method="post">
       
            <div>
              
                <div class="form-group">
                    
                    <input type="hidden" name="id_society"  value="<?php echo $p->id_society; ?>" required="">
                </div>
                <div class="form-group">
                    <input type="text" name="nom_society" placeholder="Last Name"  value="<?php echo $p->nom_society; ?>" required="">
                ...
                <div class="form-group">
                     <input type="file" name="img_society"  value="<?php echo $p->img_society; ?>" accept="image/*">
                </div>

                <div class="form-group">
                <select name="id_org"  id="id_org" >
                      <option value="$p->id_org"><?php echo $type;  ?></option>
                      <?php 
