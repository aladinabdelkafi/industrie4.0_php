...
<section class="appoinment-section section">
    ...
    <form name="contact_form" class="default-form contact-form" action="../controleur/modifspk.php" method="post">
       
            <div>
              
                <div class="form-group">
                    
                    <input type="hidden" name="id_speak"  value="<?php echo $p->id_speak; ?>" required="">
                </div>
                <div class="form-group">
                    <input type="text" name="nom" placeholder="Last Name"  value="<?php echo $p->nom; ?>" required="">
                    
                </div>
                 
                <div class="form-group">
                    <input type="text" name="prenom" placeholder="First Name"   value="<?php echo $p->prenom; ?>" required="">
                </div>

                <div class="form-group">
                    <input type="text" name="poste" placeholder="post"  value="<?php echo $p->poste; ?>"  required="">
                    
                </div>

                <div class="form-group">
                    <input type="text" name="biblio" placeholder="bibliography"  value="<?php echo $p->biblio; ?>" required="">
                    
                </div>

                <div class="form-group">
                     <input type="file" name="photo"  value="<?php echo $p->photo; ?>" accept="image/*">
                </div>
