                    ...
                    <div class="team-members tab-pane fade in active row" id="doctor">
                        ...
                        foreach($res1 as $r)
                            {
                              ...
                              if($r[1]=="Equipe programme")
                            {
                            $res=$p->consult_Id_com($r[0]);
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="team-person text-center">
                                <img src= "../images/team/<?php echo $ra[3]; ?>" class="img-responsive" alt="team">
                                <h6><?php echo $ra[1];echo "     "; echo $ra[2]; ?></h6>
                                <div class="tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <?php echo"<li>";
                                          echo"<a href='../controleur/supppers.php?id=$ra[0]'>delete</a>";
                                          echo "</li>";
                                          ?>
                                        <?php echo"<li>";
                                          echo"<a href='modifpers.php?id=$ra[0]'>modify</a>";
                                          echo "</li>";
                                          ?>
                                      </ul>
                                    </div>
