...
<section class="appoinment-section section">
    ...
    <form name="contact_form" class="default-form contact-form" action="controleur/addpart.php" method="post">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                    <input type="hidden" name="Id_ed"  value="<?php echo $id; ?>" placeholder="Last Name" required="">
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" name="organisme" placeholder="Organization" required="" id="Organization">
                </div>

                 <div class="form-group"> </div> <div class="form-group"> </div>
                <div class="form-check">
                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                <label class="form-check-label" for="exampleCheck1">I want to have a certificate</label>
              </div>
            </div>
