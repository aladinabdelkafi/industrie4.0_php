...
<section class="appoinment-section section">
    ...
    <div class="section-title">
        <h3>add a committee person  </h3>
    </div>
    <form name="contact_form" class="default-form contact-form" action="../controleur/addpers.php" method="post">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
...
?>
               ...
               <div class="form-group">
                    <select name="nom_com"  id="nom_com" >
...
?>
                ...
                <div class="form-group">
                    <input type="text" name="prenom_per" placeholder="Last Name" required="">
                    
                </div>
                 
                <div class="form-group">
                    <input type="text" name="nom_per" placeholder="First Name" required="">
                </div>
                
                <div class="form-group">
                     <input type="file" name="photo_per" accept="image/*">
                </div>
            </div>
